	...
	return (
		<div className={styles.animeCard} onClick={handleCardFullScreen}>
			<div className={styles.animeCardHeader}>
				...
				<span className={styles.animeAgeRating}>{anime.Author}</span>
			</div>
			<div className={styles.animeCoverImage}>
				<img src={animeImage} alt="Manga Image" />
			</div>
			<div>
				...
				<div className={styles.animeStatus}> <span className={styles.boldParams}>{anime.HasChapters ? 'Chapters' : 'Volumes'} : </span> {anime.Chapters}</div>
			</div>
